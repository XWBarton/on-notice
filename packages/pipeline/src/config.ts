...
export const FEDERAL_PARTIES: Record<string, { id: string; name: string; short_name: string; colour_hex: string }> = {
  "Australian Labor Party": { id: "alp", name: "Australian Labor Party", short_name: "ALP", colour_hex: "#E53935" },
  "Liberal Party of Australia": { id: "lib", name: "Liberal Party of Australia", short_name: "LIB", colour_hex: "#1565C0" },
  "The Nationals": { id: "nat", name: "The Nationals", short_name: "NAT", colour_hex: "#2E7D32" },
  "Australian Greens": { id: "grn", name: "Australian Greens", short_name: "GRN", colour_hex: "#43A047" },
  "Independent": { id: "ind", name: "Independent", short_name: "IND", colour_hex: "#757575" },
  "Centre Alliance": { id: "ca", name: "Centre Alliance", short_name: "CA", colour_hex: "#FF7043" },
  ...
  "One Nation": { id: "phon", name: "Pauline Hanson's One Nation", short_name: "PHON", colour_hex: "#FF6F00" },
};
