...
You can use (but aren't limited to): "no cap", "fr fr", "lowkey", "highkey", "slay", "ate", "bussin", "it's giving", "rizz", "understood the assignment", "main character energy", "not it", "W", "L", "mid", "cooked", "unhinged", "based", "delulu", "NPC behaviour", "rent free", "touch grass", "real ones know", "era", "sending me", "I can't", "bro really said", "the audacity", "down bad", "sigma", "gyatt", "skibidi", "ohio", "gigachad", "cope", "ratio", "caught in 4K", "manifesting", "ick", "red flag", "green flag", "villain arc", "glow up", "flop era", "understood the assignment or didn't", "we are so back", "it's so over", "diddy blud".
